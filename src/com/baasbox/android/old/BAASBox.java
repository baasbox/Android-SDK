package com.baasbox.android.old;
//
...
//
//import com.baasbox.android.api.BAASBoxClientException;
//import com.baasbox.android.api.BAASBoxInvalidSessionException;
//import com.baasbox.android.api.BAASBoxServerException;
...
// * the class {@link com.baasbox.android.old.BAASBoxResult}. If an exception has been thrown during the
// * method execution, the subsequent request of the method
// * {@link com.baasbox.android.old.BAASBoxResult#get() BAASBoxResult.get()} will throw that exception, if
...
//        } catch (com.baasbox.android.old.BAASBoxException e) {
...
//		BAASRequest<JSONObject> request = requestFactory.get(uri,true);
//
//		try {
//			JSONObject result = rest.execute(request);
