...
public class BaasAsset {
    ...
    public static <T> RequestToken get(BAASBox client, String name, T tag, Priority priority, BaasDataHandler<T> handler) {
        return get(client, name, tag, priority, handler, handler);
    }

    public static <T> RequestToken get(BAASBox client, String name, T tag, Priority priority, BAASBox.BAASHandler<BaasAsset, T> handler) {
    ...
    public static <T> RequestToken get(BAASBox client, String name, T tag, Priority priority, DataHandler<T> dataHandler, BAASBox.BAASHandler<BaasAsset, T> endHandler) {
